...
def compute_feature_importances(
    ...
    try:
        compute_permutation_imp(sklearn_model, X_explain, output_folder)
    ...
    def compute_shap_values(
        ...
        plt.tight_layout()
        plt.savefig(f"{output_folder}shap_importances.png", bbox_inches="tight")
        plt.close()
        
        
    def compute_permutation_imp(
        ...
        plt.gcf().set_size_inches(15, 8)
        plt.tight_layout()
        plt.savefig(f"{output_folder}permutation_importances.png", bbox_inches="tight")
        plt.close()
